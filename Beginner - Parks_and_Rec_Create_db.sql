...
-- Create parks_departments table (correcting AUTO_INCREMENT to IDENTITY for SQL Server)
...
-- OPTIONAL: Add foreign key constraint between employee_salary and parks_departments
